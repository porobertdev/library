        ...
        fetch(url)
            ...
            .then(data => {
                ...
                for (book of data.docs) {
                    ...
                    let html = `<div><img src="https://covers.openlibrary.org/b/id/${book.cover_i}-L.jpg?default=false"><p class="title">${book.title}></p><p class="author">${book.author_name}</p></div>`;
